                        ...
                        <div class="flex flex-wrap -mx-6">
                            <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700">${users.size()}</h4>
                                ...
                                <table class="min-w-full">
                                    ...
                                    <c:forEach var="user" items="${users}">
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">${user.birthDate}</div>

                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <span
                                                        class="inline-flex px-2 text-xs font-semibold leading-5 ${user.role == "ADMIN" ? "text-green-800 bg-green-100" : "text-blue-800 bg-blue-100"} rounded-full">
                                                        ${user.role}
                                                </span>
                                            </td>
